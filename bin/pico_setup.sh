...
# Declare warning to user before beginning
echo "WARNING: This is a modified setup script for the Raspberry Pi, use at your own risk"

# Number of cores when running make
JNUM=4

# Change directory to home directory, save current
CWD=$(pwd)
cd ~ 
...
# Add PICO_INSTALL_PATH to ~/.bashrc
echo "Adding PICO_INSTALL_PATH to ~/.bashrc"
echo "export PICO_INSTALL_PATH=~/pico" >> ~/.bashrc
export PICO_INSTALL_PATH=~/pico
