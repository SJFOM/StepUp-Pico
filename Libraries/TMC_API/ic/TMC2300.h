...
#define TMC2300_FIELD_WRITE(tdef, address, mask, shift, value) \
    (tmc2300_writeInt(                                         \
        tdef,                                                  \
        address,                                               \
        FIELD_SET(tmc2300_readInt(tdef, address), mask, shift, value)))
...
static const uint8_t tmc2300_defaultRegisterAccess[TMC2300_REGISTER_COUNT] = {
    ...
    //  E     F
    0x43, 0x23, 0x01, 0x02, ____, ____, 0x01, ____,
    ____, ____, ____, ____, ____, ____, ____, ____,  // 0x00 - 0x0F
    0x42, 0x42, 0x01, ____, 0x02, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____,  // 0x10 - 0x1F
    ____, ____, 0x02, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____,  // 0x20 - 0x2F
    ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____,  // 0x30 - 0x3F
    0x02, 0x01, 0x02, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____,  // 0x40 - 0x4F
    ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____,  // 0x50 - 0x5F
    ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, 0x01, ____, 0x43, ____, ____, 0x01,  // 0x60 - 0x6F
    0x43, 0x01, 0x01, ____, ____, ____, ____, ____,
...
// Register constants. These are required for 0x42 registers, since we do not
// have any way to find out the content. For 0x43 registers, it is not necessary
// to load the constant values this way, but this allows users to directly see
// the contents while still in standby.
...
static inline void tmc2300_writeInt(TMC2300TypeDef *tmc2300,
                                    uint8_t address,
                                    int32_t value);
static inline int32_t tmc2300_readInt(TMC2300TypeDef *tmc2300, uint8_t address);

void tmc2300_init(TMC2300TypeDef *tmc2300,
                  uint8_t channel,
...
void tmc2300_setRegisterResetState(TMC2300TypeDef *tmc2300,
                                   const int32_t *resetState);
